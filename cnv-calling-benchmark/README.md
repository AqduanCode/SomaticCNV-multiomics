...
```text
# chr  chr_start  chr_stop   variation
...
Repeat for the control sample. The resulting BAMs are the inputs to all callers below. Example BAMs are available through OMIX website (OMIX018267).
